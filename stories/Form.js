                ...
                <div style={{ backgroundColor: '#0c0f21', position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }}>
                    <div style={{ width: '320px', margin: '50px auto', padding: '0 10px' }}>
                        <Form>
                            ...
                            <Field placeholder="Select" multiple="true" type="select" options={citySelectItems} width="fixed" component={FormField} name="select" />
                            <Label text="Select one" disabled="true" />
                            <Field placeholder="Select" type="select" options={citySelectItems} width="fixed" component={FormField} name="select" />
